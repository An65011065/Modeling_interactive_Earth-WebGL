...
class WebGLEarth {
  ...
  compile() {
    ...
    // void main(){
    // gl_position = vec4(a_Position, 0, 1) #setting the z-coordinate to 0
    // }`;

    // const bgFragmentShaderSource = `
    // precision mediump float;
    // uniform sampler 2D bgTexture;
  ...
  write() {
    ...
    // gl.bindBuffer(gl.ARRAY_BUFFER, this.quadtriangleBuffer);
    // gl.bufferData(gl.ARRAY_BUFFER, triIndices, gl.STATIC_DRAW)
